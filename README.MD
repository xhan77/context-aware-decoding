...
$$y_t \sim \text{softmax}[(1+\alpha) \text{logit}_\theta(y_t \mid \boldsymbol{c}, \boldsymbol{x}, \boldsymbol{y}[\lt t]) - \alpha \text{logit}_\theta(y_t \mid \boldsymbol{x}, \boldsymbol{y}[\lt t])]$$
