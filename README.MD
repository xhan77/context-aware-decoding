...
$$y_t \sim \text{softmax} \left[ (1+\alpha) \text{logit}_\theta \left( y_t \mid \boldsymbol{c}, \boldsymbol{x}, \boldsymbol{y}[\lt t] \right) - \alpha \text{logit}_\theta \left( y_t \mid \boldsymbol{x}, \boldsymbol{y}[\lt t] \right) \right]$$
